      ...
      <div>
        ...
        {/* <div className="row bd-highlight mb-3"> */}
            <div className="btn mr-auto p-2 bd-highlight">
                <a className="btn col-1" href="https://www.facebook.com/netflixfrance" target="_blank" id="btnf" >

                    <i class="fa fa-facebook-official" aria-hidden="true" id="iconf"></i>

                </a>

                <a className="btn col-1 " href="https://www.instagram.com/netflixfr/?hl=fr" target="_blank" id="btni">

                    <i class="fa fa-instagram" aria-hidden="true" id="iconi"></i>

                </a>

                <a className="btn col-1" href="https://twitter.com/NetflixFR" target= "_blank" id="btnt">
